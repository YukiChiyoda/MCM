...
# 绘制数据点
plt.scatter(*real_data_point, s=100, label='Nash Equilibrium Point', color=COLORS_ORANGE[2], edgecolors='#381E21')
# plt.scatter(0, 0, s=100, color=COLORS_GREEN[-2], edgecolors='#381E21')
...
# 绘制分向量线段
# 水平线段
plt.plot([real_data_point[0], 0], [real_data_point[1], real_data_point[1]], linestyle='--',
         linewidth=2, color='#381E21')
# # 垂直线段
plt.plot([real_data_point[0], real_data_point[0]], [real_data_point[1], 0], linestyle='--',
         linewidth=2, color='#381E21')
...
# 显示图像
plt.savefig(r'./output/Nash Equilibrium 3-2.svg')
plt.show()
