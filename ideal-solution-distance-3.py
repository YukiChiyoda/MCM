...
# 绘制数据点
plt.scatter(*real_data_point2, s=100, color=COLORS_RED[-2], edgecolors='#381E21', zorder=100,
            clip_on=False)

# 绘制分向量线段
# 水平线段
plt.plot([real_data_point2[0], ideal_data_point[0]], [real_data_point2[1], real_data_point2[1]], linestyle='--',
         linewidth=2, color='#381E21')
# 垂直线段
plt.plot([real_data_point2[0], real_data_point2[0]], [real_data_point2[1], ideal_data_point[1]], linestyle='--',
         linewidth=2, color='#381E21')
...
# 显示图像
plt.savefig(r'./output/Clients Resources-3.svg')
plt.show()
