...
ax.text(0.05, 0.99, 'a)', transform=ax.transAxes, verticalalignment='top', horizontalalignment='left', fontsize=24,
        fontweight='bold', color='black')

plt.savefig(r'./output/Wildlife Trade Volume by Countries in 2016 & 2017.svg', bbox_inches='tight')
plt.show()
